...
fun computeP2PkhAddress(pub: PublicKey, chainHash: ByteVector32): String  {
    ...
    return when(chainHash) {
        Block.RegtestGenesisBlock.hash, Block.TestnetGenesisBlock.hash -> Base58Check.encode(Base58.Prefix.PubkeyAddressTestnet, hash)
...
fun computeP2ShOfP2WpkhAddress(pub: PublicKey, chainHash: ByteVector32): String {
    ...
    return when(chainHash) {
        Block.RegtestGenesisBlock.hash, Block.TestnetGenesisBlock.hash -> Base58Check.encode(Base58.Prefix.ScriptAddressTestnet, hash)
