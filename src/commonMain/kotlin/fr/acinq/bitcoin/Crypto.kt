...
public object Crypto {
    ...
    public sealed class SchnorrTweak {
         ...
         */
        public object NoScriptTweak : SchnorrTweak()
         ...
         */
        public data class ScriptTweak(val merkleRoot: ByteVector32) : SchnorrTweak()
    }
    ...
    public fun signSchnorr(data: ByteVector32, privateKey: PrivateKey, schnorrTweak: SchnorrTweak, auxrand32: ByteVector32? = null): ByteVector64 {
        val priv = when(schnorrTweak)  {
            ...
            SchnorrTweak.NoScriptTweak -> privateKey.tweak(privateKey.xOnlyPublicKey().tweak(null))
            is SchnorrTweak.ScriptTweak -> privateKey.tweak(privateKey.xOnlyPublicKey().tweak(schnorrTweak.merkleRoot))
        }
