...
public object MnemonicCode {
    public val englishWordlist: List<String> by lazy {
    ...
    private val englishWorldMap: Map<String, Int> by lazy { englishWordlist.mapIndexed { index, s -> s to index }.toMap() }
    ...
    public fun validate(mnemonics: List<String>, wordlist: List<String> = englishWordlist) {
        ...
        val wordMap = if (wordlist == englishWordlist) englishWorldMap else wordlist.mapIndexed { index, s -> s to index }.toMap()
