...
//}
//
//public fun Secp256k1.computeCompressedPublicKey(priv: ByteArray): ByteArray {
//    val pub = computePubkey(priv)
//    pub[0] = if (pub[64].rem(2) == 0) 0x02.toByte() else 0x03.toByte()
//    return pub.copyOfRange(0, 33)
//}
//
//public fun Secp256k1.ecdhCompressed(priv: ByteArray, pub: ByteArray): ByteArray {
//    val uncompressedPub = parsePubkey(pub)
//    return createECDHSecret(priv, uncompressedPub)
//}
