...
class BIP49TestsCommon {
    ...
    fun `BIP49 reference tests`() {
        ...
        val accountKey = DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/49'/1'/0'"))
        ...
        assertEquals(key.secretkeybytes, DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/49'/1'/0'/0/0")).secretkeybytes)
        assertEquals(key.privateKey.toBase58(Base58.Prefix.SecretKeyTestnet) , "cULrpoZGXiuC19Uhvykx7NugygA3k86b3hmdCeyvHYQZSxojGyXJ")
        assertEquals(key.privateKey , PrivateKey(Hex.decode("c9bdb49cfbaedca21c4b1f3a7803c34636b1d7dc55a717132443fc3f4c5867e801")))
        assertEquals(key.publicKey , PublicKey(Hex.decode("03a1af804ac108a8a51782198c2d034b28bf90c8803f5a53f76276fa69a4eae77f")))
