...
class BIP84TestsCommon {
    ...
    fun `"BIP49 reference tests`() {
        ...
        val accountKey = DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/84'/0'/0'"))
        ...
        assertEquals(key.secretkeybytes, DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/84'/0'/0'/0/0")).secretkeybytes)
        assertEquals(key.privateKey.toBase58(Base58.Prefix.SecretKey), "KyZpNDKnfs94vbrwhJneDi77V6jF64PWPF8x5cdJb8ifgg2DUc9d")
        assertEquals(key.publicKey, PublicKey(Hex.decode("0330d54fd0dd420a6e5f8d3624f5f3482cae350f79d5f0753bf5beef9c2d91af3c")))
        ...
        assertEquals(key1.secretkeybytes, DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/84'/0'/0'/0/1")).secretkeybytes)
        assertEquals(key1.privateKey.toBase58(Base58.Prefix.SecretKey), "Kxpf5b8p3qX56DKEe5NqWbNUP9MnqoRFzZwHRtsFqhzuvUJsYZCy")
        assertEquals(key1.publicKey, PublicKey(Hex.decode("03e775fd51f0dfb8cd865d9ff1cca2a158cf651fe997fdc9fee9c1d3b5e995ea77")))
        ...
        assertEquals(key2.secretkeybytes, DeterministicWallet.derivePrivateKey(master, DeterministicWallet.KeyPath("m/84'/0'/0'/1/0")).secretkeybytes)
        assertEquals(key2.privateKey.toBase58(Base58.Prefix.SecretKey), "KxuoxufJL5csa1Wieb2kp29VNdn92Us8CoaUG3aGtPtcF3AzeXvF")
        assertEquals(key2.publicKey, PublicKey(Hex.decode("03025324888e429ab8e3dbaf1f7802648b9cd01e9b418485c5fa4c1b9b5700e1a6")))
