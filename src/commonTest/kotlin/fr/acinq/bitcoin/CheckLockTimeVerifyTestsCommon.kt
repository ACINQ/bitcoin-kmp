...
class CheckLockTimeVerifyTestsCommon {
    ...
    fun `BIP65 payment channels`() {
        ...
        val keyAlice = PrivateKey(Hex.decode("C0B91A94A26DC9BE07374C2280E43B1DE54BE568B2509EF3CE1ADE5C9CF9E8AA"))
        val pubAlice = keyAlice.publicKey()

        val keyBob = PrivateKey(Hex.decode("5C3D081615591ABCE914D231BA009D8AE0174759E4A9AE821D97E28F122E2F8C"))
