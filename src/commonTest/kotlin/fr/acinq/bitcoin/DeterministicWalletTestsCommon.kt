...
class DeterministicWalletTestsCommon {
    ...
    fun `parse string-formatted derivation paths`() {
        assertEquals(KeyPath("m/44'/0'/0'/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))
        assertEquals(KeyPath("m/44h/0h/0h/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))

        assertEquals(KeyPath("m/44'/0'/0'/0").asString('\''), "m/44'/0'/0'/0")
        assertEquals(KeyPath("m/44'/0'/0'/0").asString('h'), "m/44h/0h/0h/0")
        assertEquals(KeyPath("m/44h/0h/0h/0").asString('\''), "m/44'/0'/0'/0")
        assertEquals(KeyPath("m/44h/0h/0h/0").asString('h'), "m/44h/0h/0h/0")

        assertEquals(KeyPath("/44'/0'/0'/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))
        assertEquals(KeyPath("/44h/0h/0h/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))

        assertEquals(KeyPath("44'/0'/0'/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))
        assertEquals(KeyPath("44h/0h/0h/0"), KeyPath(listOf(hardened(44), hardened(0), hardened(0), 0)))

        assertEquals(KeyPath("m/44/0'/0'/0"), KeyPath(listOf(44, hardened(0), hardened(0), 0)))
        assertEquals(KeyPath("m/44/0h/0h/0"), KeyPath(listOf(44, hardened(0), hardened(0), 0)))
