...
class SegwitTestsCommon {
    ...
    fun `create p2wpkh tx`() {
        ...
        val tx2 = run {
            val tmp = Transaction(
                ...
                txOut = listOf(TxOut(3900000L.toSatoshi(), Script.pay2wpkh(pub1))),
                lockTime = 0
            )
    ...
    fun `create p2wsh tx`() {
        ...
        val tx2 = run {
            ...
            val tmp = Transaction(
                ...
                txOut = listOf(TxOut(4900000L.toSatoshi(), Script.pay2wsh(redeemScript))),
                lockTime = 0
            )
            val sig = Transaction.signInput(
                tmp,
    ...
    fun `create p2pkh embedded in p2sh`() {
        ...
        val tx = Transaction.read(
            "",
            pversion
        )
        ...
        val tx1 = run {
            val tmp = Transaction(
                ...
                txOut = listOf(TxOut(4900000L.toSatoshi(), listOf(OP_0, OP_PUSHDATA(pub1.hash160())))),
                lockTime = 0
            )
            val pubKeyScript = Script.pay2pkh(pub1)
            val sig = Transaction.signInput(
