...
class TransactionTestsJvm {
    ...
    fun `create and verify simple transactions`() {
        ...
        val (privateKey, _) = PrivateKey.fromBase58("cRp4uUnreGMZN8vB7nQFX6XWMHU5Lc73HMAhmcDEwHfbgRS66Cqp", Base58.Prefix.SecretKeyTestnet)
    ...
    fun `create and sign p2sh transactions`() {
        ...
        val (privateKey, _) = PrivateKey.fromBase58("92TgRLMLLdwJjT1JrrmTTWEpZ8uG7zpHEgSVPTbwfAs27RpdeWM", Base58.Prefix.SecretKeyTestnet)
        val publicKey = privateKey.publicKey()
