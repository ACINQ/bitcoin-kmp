...
class CryptoTestsJvm {
    @Test
    fun `sha1`() {
        val foo = Sha1.hash("abc".encodeToByteArray())
    }
    @Test
    ...
    fun `sign and verify signatures`() {
        ...
        val encoded1 = ByteVector64("fb36b33afe9308f9eebfcdb0f50cb9c51c72e98a578ee26cabf4a26b5aba1fbf2429e5f5081488190fb01c5165189f2c70e619a3b667e6f1e0fc861d5a8a25d1")
        assert(Crypto.verifySignature(data, encoded1, publicKey))
    }

    @InternalSerializationApi
    @Test
    fun `der2compact`() {
        assertEquals(ByteVector64("3f16c6f40162ab686621ef3000b04e75418a0c0cb2d8aebeac894ae360ac1e78223ea13203caf853b71e97e5cc149f65547d1d7ab98c96353d0d8318934e7716"), Crypto.der2compact(Hex.decode("304402203f16c6f40162ab686621ef3000b04e75418a0c0cb2d8aebeac894ae360ac1e780220ddc15ecdfc3507ac48e1681a33eb60996631bf6bf5bc0a0682c4db743ce7ca2b01")))
    }
}