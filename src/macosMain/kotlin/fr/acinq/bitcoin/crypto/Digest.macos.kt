...
internal class DigestMacos<C : CVariable>(
...
internal actual fun Sha1(): Digest =
    DigestMacos("SHA-1", CC_SHA1_DIGEST_LENGTH, ::CC_SHA1_Init, ::CC_SHA1_Update, ::CC_SHA1_Final) { nativeHeap.alloc() }

internal actual fun Sha256(): Digest =
    DigestMacos("SHA-256", CC_SHA256_DIGEST_LENGTH, ::CC_SHA256_Init, ::CC_SHA256_Update, ::CC_SHA256_Final) { nativeHeap.alloc() }

internal actual fun Sha512(): Digest =
    DigestMacos("SHA-512", CC_SHA512_DIGEST_LENGTH, ::CC_SHA512_Init, ::CC_SHA512_Update, ::CC_SHA512_Final) { nativeHeap.alloc() }
